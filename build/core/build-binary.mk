...
$(LOCAL_INSTALLED): PRIVATE_SRC     := $(LOCAL_BUILT_MODULE)$(HOST_PRIVATE_SRC_EXECUTABLE_SUFFIX)
$(LOCAL_INSTALLED): PRIVATE_DST_DIR := $(NDK_APP_PROJECT_PATH)/libs/host
$(LOCAL_INSTALLED): PRIVATE_DST     := $(NDK_APP_PROJECT_PATH)/libs/host/$(notdir $(LOCAL_BUILT_MODULE))$(HOST_EXECUTABLE_SUFFIX)
endif
ifeq ($(LOCAL_MODULE_CLASS), HOST_STATIC_LIBRARY)
$(LOCAL_INSTALLED): PRIVATE_DST_DIR := $(NDK_APP_PROJECT_PATH)/libs/host
$(LOCAL_INSTALLED): PRIVATE_DST     := $(NDK_APP_PROJECT_PATH)/libs/host/$(notdir $(LOCAL_BUILT_MODULE))
endif
