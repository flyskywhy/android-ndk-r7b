...
ifeq ($(LOCAL_my),HOST_)
LOCAL_SRC_FILES_TARGET_CFLAGS.$(1) := $(HOST_GLOBAL_CFLAGS)
endif
_FLAGS := $$($$(LOCAL_my)CFLAGS) \
          $$(call get-src-file-target-cflags,$(1)) \
          $$(call host-c-includes,$$(LOCAL_C_INCLUDES) $$(LOCAL_PATH)) \
          $$(LOCAL_CFLAGS) \
          $$(NDK_APP_CFLAGS) \
          $$(call host-c-includes,$$($(LOCAL_my)C_INCLUDES)) \
          -c \

_TEXT := "Compile $$(call get-src-file-text,$1)"
_CC   := $$(NDK_CCACHE) $$($$(LOCAL_my)CC)
...
# host executable
# <foo> -> <foo>
# a host executable is installable.
$(call module-class-register-installable,HOST_EXECUTABLE,,)
